...
```
## OUTPUT:
![output](https://github.com/21005984/AngularCalculation/blob/main/immg.png?raw=true)
## Result:
The webpage for mathematical calculation is successfully created using angular.
